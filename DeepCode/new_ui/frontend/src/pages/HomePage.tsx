...
const actions = [
  {
    ...
    description: 'Discover → summarize → clarify → reproduce, end to end',
  ...
  },
  {
    ...
    description: 'Map a field with You.com research — papers, methods, datasets',
    ...
    <div className="space-y-12">
      ...
      >
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Discover papers with You.com, map the research landscape as a knowledge
          graph, summarize into your wiki, and reproduce papers as running code.
        </p>
      </motion.div>
